...
public class LoveStoriesTextManager : MonoBehaviour
{
    [Header("Ink Story")]
    ...
    public void ChooseByText(string choiceText)
    {
        Debug.Log("choosebytext called");
        Debug.Log("Current Ink Choices:");
        foreach (var choice in story.currentChoices)
        {
            Debug.Log($"- '{choice.text}' (index {choice.index})");
        }
